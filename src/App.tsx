    ...
    <TooltipProvider>
      ...
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/crops" element={<AppLayout><CropTrackingPage /></AppLayout>} />
          <Route path="/disease" element={<AppLayout><DiseaseDetectionPage /></AppLayout>} />
          <Route path="/inventory" element={<AppLayout><InventoryPage /></AppLayout>} />
          <Route path="/weather" element={<AppLayout><WeatherPage /></AppLayout>} />
          <Route path="/recommendations" element={<AppLayout><CropRecommendationPage /></AppLayout>} />
